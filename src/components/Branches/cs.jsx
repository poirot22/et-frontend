...
import cscover from "../../assets/cs-cover.jpg";
import "./aiml.css";
    ...
    <>
        <div className="relative h-80 header">
          ...
          >
            <h1 className="text-4xl text-white font-bold">
              DEPARTMENT OF CSE (CYBER SECURTIY)
            </h1>
          </div>
        </div>
        ...
        <div>
          <div class="mt-5 text-justify">
            The Cyber Security Department at CVR College of Engineering stands
            as a dynamic nucleus within the academic ecosystem, specializing in
            the realm of Cyber Security. Committed to cultivating future experts
            and leaders in the field, the department places a strong emphasis on
            furnishing students with a robust foundation in Cyber Security
            principles, complemented by hands-on experiences. The department
            takes pride in its meticulously designed curriculum that encompasses
            both fundamental theories and real-world applications of Cyber
            Security. Bolstered by a cadre of seasoned faculty members,
            cutting-edge infrastructure, and state-of-the-art labs, students are
            provided with the essential tools to explore, experiment, and
            actively contribute to the forefront of cybersecurity advancements.
            Adopting a student-centric approach, the Cyber Security Department
            at CVR College of Engineering prioritizes holistic development.
            Through avenues such as research opportunities, strategic industry
            partnerships, and comprehensive career development programs, the
            department ensures that students not only acquire theoretical
            knowledge but also practical skills and industry exposure. By
            fostering a dynamic learning environment, the department strives to
            prepare students for successful careers in the ever-evolving and
            critical field of Cyber Security. The commitment to excellence is
            evident in the department's dedication to shaping well-rounded
            professionals who can confidently navigate the complex landscape of
        ...
        <div className=" mr-12 mt-4 mb-5">
          <h1 className="text-3xl font-semibold mb-5 heading-top pl-4">
            CSE (Cyber Security) Course Structure
          </h1>
