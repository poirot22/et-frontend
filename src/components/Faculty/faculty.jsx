    ...
    <>
      <div className="flex flex-wrap">
        {faculty.map((item) => (
          ...
          >
            <div
              className="rounded-lg overflow-hidden shadow-md relative p-3 bg-gray-200 cursor-pointer lg:hover:scale-105 transition duration-300 ease-in-out"
              onClick={() => handleFacultyClick(item)}
            >
              <div className="aspect-w-3 aspect-h-5 flex justify-center">
                <img
                  className="object-cover w-3/4 rounded-t-md"
                  src={item.picture}
                  alt=""
                />
              </div>
