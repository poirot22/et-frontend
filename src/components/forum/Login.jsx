          ...
          <form onSubmit={handleSubmit} className="w-full">
            <div className="mb-4">
              <input
                ...
                className="p-3 border border-gray-600 rounded-3xl focus:outline-none focus:border-blue-500 bg-gray-100 text-gray-800 placeholder-gray-500 bg-gradient-to-br from-green-300 to-blue-300 w-full"
